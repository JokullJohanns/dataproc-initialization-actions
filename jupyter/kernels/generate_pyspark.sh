...
cat << EOF
{
 ...
 "env": {
    ...
    "PYSPARK_SUBMIT_ARGS": "--master yarn --py-files gs://jokull/graphframes_2.11-0.6.0-SNAPSHOT-spark2.2.jar --jars gs://jokull/graphframes_2.11-0.6.0-SNAPSHOT-spark2.2.jar,gs://jokull/scala-logging-slf4j_2.11-2.1.2.jar,gs://jokull/scala-logging-api_2.11-2.1.2.jar --deploy-mode client ${PACKAGES_ARG} pyspark-shell"
 }
}
EOF
